...
public:
	...
	bool Download2Mem(const string &url ,string &content,long &http_code,const bool use_mobile_useraget=false,const bool bToUtf8=true, const size_t timeout_s=TIME_INFINIT);
	bool Download2File(const string &strURL, const string &filename,long &http_code, const bool use_mobile_useraget=false,const size_t timeout_s = TIME_INFINIT);
