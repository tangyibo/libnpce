...
{
	int nLen = 1;
	if ((sLine[0] & 0x80) == 0x0)   // 单字节字符 0xxxxxxx
	{
		nUnicode =(unsigned char)sLine[0];
	}
	else if ((sLine[0] & 0xE0) == 0xC0) // 双字节 110xxxxx 10xxxxxx
	{	/*1 1 0 x10 x9 x8 x7 x6 先与上0x1F即(11111)变为x10 x9 x8 x7 x6在左移六位
		  x10 x9 x8 x7 x6 0  0  0  0  0  0 
		  将1 0 x5 x4 x3 x2 x1 x0 先与上3F即(111111)变为
					0	0 x5 x4 x3 x2 x1 x0
		   相加得到x10 x9 x8 x7 x6 x5 x4 x3 x2 x1 x0
	    3字节的同理
		*/
	...
	else if ((sLine[0] & 0xF0) == 0xE0)   // 三字节 1110xxxx 10xxxxxx 10xxxxxx
	{
